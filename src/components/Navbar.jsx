  ...
  return (
    <nav className="w-full py-7 px-8 max-h-[80px] bg-white fixed top-0 left-0 z-50 flex items-center">
      <div className="w-full flex justify-between items-center">
        <span className='font-grotesk font-semibold text-4xl'>SMSGC</span>
        ...
        <div className="hidden pl-6 flex-1 lg:flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Button href='#' text="Register" styles="bg-[#FFDE02] min-h-12 min-w-[100px]" />
            <Button href='#' text="Sign in" styles="bg-[#090B0C10] min-h-12 min-w-[100px]" />
